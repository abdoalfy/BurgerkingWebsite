   ...
   <section class="cart container mt-2 my-3 py-5">
    ...
    <table class="pt-5">
      ...
      @if(Session::has('cart'))
          ...
          <tr>
            <td>
              <div class="product-info">
                <img style="width:100px; height: 60px;" src="{{asset('images/'.$product['image'])}}">
                <div>
                  <p>{{$product['name']}}</p>
                  <small><span>$</span>{{$product['id']}}</small>
                  <br>
       ...
       <span class="product_price">$ {{ $product['id'] * $product['quantity']}}</span>
            </td>
          </tr>
        @endforeach 
       @endif   
