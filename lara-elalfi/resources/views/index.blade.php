                    ...
                    <div class="col-sm-4">
                        <div class="menu">
                            <div class="inner_content">
                                <span class="flaticon flaticon-burger"></span>
                                <h2><a style="color:#fff" href="{{route('products')}}">menu</a></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="drinks">
                            <div class="inner_content">
                                ...
                                <h2><a style="color:#fff" href="{{route('category',['category'=>'beverages'])}}">drinks</a></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="sides">
                            <div class="inner_content">
                                ...
                                <h2><a style="color:#fff" href="{{route('category',['category'=>'pizza'])}}">pizza</a></h2>
                            </div>
                        </div>
                    </div>
